 ...
 * Approve pending admin (SYSTEM_ADMIN only)
 */
export async function POST(_request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    admin.onboardingStatus = OnboardingStatus.APPROVED;
    admin.isActive = false; // remains inactive until activation completes
    ...
    console.error('Error in POST /api/admin/admins/[id]/approve:', error);
